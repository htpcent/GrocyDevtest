Grocy.Components.CustomProductCard = {};

Grocy.Components.CustomProductCard.Refresh = function(productId)
{
				...
				Grocy.Api.Get('stock/products/' + productId + '/price-history',
					function(priceHistoryDataPoints)
					{
						if (priceHistoryDataPoints.length > 0)
						{
							...
							Grocy.Components.CustomProductCard.ReInitPriceHistoryChart();
							var datasets = {};
							var chart = Grocy.Components.CustomProductCard.PriceHistoryChart.data;
							...
							Grocy.Components.CustomProductCard.PriceHistoryChart.update();
						}
						else
						{
...
Grocy.Components.CustomProductCard.ReInitPriceHistoryChart = function()
{
	if (typeof Grocy.Components.CustomProductCard.PriceHistoryChart !== "undefined")
	{
		Grocy.Components.CustomProductCard.PriceHistoryChart.destroy();
	}

	var format = 'YYYY-MM-DD';
	Grocy.Components.CustomProductCard.PriceHistoryChart = new Chart(document.getElementById("productcard-product-price-history-chart"), {
		type: "line",
		data: {
			labels: [ //Date objects
				// Will be populated in Grocy.Components.CustomProductCard.Refresh
			],
			datasets: [ //Datasets
				// Will be populated in Grocy.Components.CustomProductCard.Refresh
			]
...
$(document).on("click", ".productcard-trigger", function(e)
{
	...
	if (productId != "")
	{
		Grocy.Components.CustomProductCard.Refresh(productId);
